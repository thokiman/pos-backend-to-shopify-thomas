 ...
 * 准动网络科技-银豹收银系统
 */
package cn.leadpad.pospal.common.utils.io;
...
public class IOUtils {
	...
	public static void closeQuietly(Closeable needCloseObj) {
		if(needCloseObj == null) return;
		try {
			needCloseObj.close();
		} catch (IOException e) {
			//e.printStackTrace();
    ...
    public static InputStream unGZIP(InputStream inputStream, int size) throws IOException {
        return new GZIPInputStream(inputStream, size);
    }
}
